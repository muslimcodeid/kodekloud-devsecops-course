pipeline {
  ...
  stages {
      ...
      stage('Sonarqube - SAST') {
        steps {
             sh "mvn clean verify sonar:sonar -Dsonar.projectKey=numeric-application -Dsonar.host.url:http://srv.standbywith.me:8080 -Dsonar.token=sqb_6420b456ce6764b939b73301cdeab818efdbe344"
            }
        }
